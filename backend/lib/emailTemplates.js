...
exports.buildCompletionEmail = buildCompletionEmail;
exports.buildDeliveryFileEmail = buildDeliveryFileEmail;
exports.buildStatusChangeEmail = buildStatusChangeEmail;
exports.buildETAChangeEmail = buildETAChangeEmail;
exports.buildProjectFeedbackEmail = buildProjectFeedbackEmail;
...
// ─── Shared HTML shell ────────────────────────────────────────────────────────
function shell(logoUrl, accentColor, content) {
    return `<!DOCTYPE html>
...
function timelineBar(dateReceived, dateDelivered, days) {
    if (!dateReceived)
        return '';
    return `
  <tr>
...
// ═══════════════════════════════════════════════════════════════════════════════
async function buildCompletionEmail(to, project) {
...
// ═══════════════════════════════════════════════════════════════════════════════
async function buildDeliveryFileEmail(to, project, files) {
    const logoUrl = await getLogoUrl();
...
// ═══════════════════════════════════════════════════════════════════════════════
async function buildStatusChangeEmail(to, project, newStatus) {
    const logoUrl = await getLogoUrl();
    const accentMap = {
        'In Process': BLUE,
        'On Hold': AMBER,
...
// ═══════════════════════════════════════════════════════════════════════════════
async function buildETAChangeEmail(to, project, oldDays, newDays, reason) {
    const logoUrl = await getLogoUrl();
...
async function buildProjectFeedbackEmail(to, project, actionType, message, items, adminName) {
    const logoUrl = await getLogoUrl();
    const ACTION_META = {
...
async function buildWelcomeEmail(to, fullName, tempPassword) {
    const logoUrl = await getLogoUrl();
...
async function buildPasswordResetEmail(to, resetLink) {
    const logoUrl = await getLogoUrl();
    const content = `
    <!-- Header banner -->
    <tr>
